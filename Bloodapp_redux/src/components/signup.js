...
import {SigninComponent} from '../container/signup'

  export class BloodReg extends Component{
constructor(props){
...
FirebaseService.customAuth(enterUser).then((user)=>{
      multipath[`users/${user.uid}`] = enterUser;
...
return{
 ...
 export default connect(mapStateToprops,mapDispatchToProps)(BloodReg);
